    ...
    <?php
        ...
        if(isset($_GET['private'])) {
            $status = 1;
            $buttons = '<a class="def_passive" href="Custom-checklist.php?public">Public</a><a class="def_active" href="Custom-checklist.php?private"' . $id_url . '>Privite</a>';
        }else if(isset($_GET['public'])) {
            $status = 0;
            $buttons = '<a class="def_active" href="Custom-checklist.php?public">Public</a><a class="def_passive" href="Custom-checklist.php?private"' . $id_url . '>Privite</a>';
        }
