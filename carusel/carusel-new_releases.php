...
<h2 class="text-center text-uppercase"><a href="releases.php">new releases</a></h2>
      ...
      <div class="container">
        ...
        $sql="SELECT re.name_of_collection, re.year_of_releases, re.sport_type, re.image, sp.sport_type, sp.sport_logo AS 'sport_logo' FROM collections re, sports_type sp WHERE sp.sport_type=re.sport_type limit 20";
