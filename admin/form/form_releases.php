                  ...
                  $arr=array();
                      ...
                      if($pop==0){
                       ...
                       $description='';
                        ...
                        $sql_insert = "INSERT INTO collections (sort_number, name_of_collection, year_of_releases, producer, sport_type, image, description, product_type, release_date) VALUES ($sort_number, '$name_collection', '$year_of_releases', '$producer', '$sport_type', '$newname', '$description', '$product_type','$release_date')";
