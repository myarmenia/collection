...
// echo $name.$country.$email.$password.$cPassword;
	...
	elseif($password!=$cPassword){
		...
		if($sql->num_rows>0){
			...
			$r = $con->query("INSERT INTO users (name,email, password,isEmailConfirmed,token,country, country_code, city, birth_day) VALUES('$name','$email', '$hashedPassword','0','$token','$country', '$country_code', '$city', $bday)");
            var_dump($r.' 4444');
